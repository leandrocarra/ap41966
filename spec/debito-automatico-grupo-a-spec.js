...
xdescribe('Débito Automático Grupo A', function() {
    ...
    it('tc7674_debitoAutomatico_SemPreenhcerAgencia', function () {
        //Tela de cadastro
        element(by.css('.btn-neoprimary')).click();
        //Tela de dados bancários
        browser.wait(ExpectedConditions.presenceOf(element(by.id('tituloH2'))), 5000);
    ...
    it('tc7675_debitoAutomatico_SemPreenhcerConta', function () {
        //Tela de cadastro
        element(by.css('.btn-neoprimary')).click();
        //Tela de dados bancários
        browser.wait(ExpectedConditions.presenceOf(element(by.id('tituloH2'))), 5000);
    ...
    it('tc7676_debitoAutomatico_SemPreenhcerDigitoConta', function () {
        //Tela de cadastro
        element(by.css('.btn-neoprimary')).click();
        //Tela de dados bancários
        browser.wait(ExpectedConditions.presenceOf(element(by.id('tituloH2'))), 5000);
