...
xdescribe('Consultar Home Grupo B', function() {
    ...
    it('tc7610_consultarHomeGrupoB_fluxoBasico', function () {
        //1. Cabeçalho
        //Logo
    ...
    it('tc7612_consultarHomeGrupoB_cardFaturaAtrasada', function () {
    ...
    it('tc7623_consultarHomeGrupoB_selecionarChave', function () {
        //Histórico de consumo
        expect(element(by.cssContainingText('.titulo-grupo-b.ng-star-inserted', 'HISTÓRICO DE CONSUMO')));
    ...
    it('tc7624_consultarHomeGrupoB_saibaMais', function () {
        //Histórico de consumo
        expect(element(by.cssContainingText('.titulo-grupo-b.ng-star-inserted', 'HISTÓRICO DE CONSUMO')));
        //Botão de saiba mais do histórico
    ...
    it('tc7627_consultarHomeGrupoB_ultimasSolicitacoes', function () {
        //Últimas solicitações
        expect(element(by.cssContainingText('.solicitacoes-header', 'ÚLTIMAS SOLICITAÇÕES')));
    ...
    it('tc7628_consultarHomeGrupoB_historicoSolicitacoes', function () {
        //Últimas solicitações
        expect(element(by.cssContainingText('.solicitacoes-header', 'ÚLTIMAS SOLICITAÇÕES')));
        element(by.cssContainingText('.mat-button-wrapper', 'VER HISTÓRICO DE PROTOCOLOS')).click();
    })

    it('tc7635_consultarHomeGrupoB_trocarImovel', function () {
        //UC com endereço
    ...
    it('tc7636_consultarHomeGrupoB_bandeiraTarifaria', function () {
    ...
    it('tc7637_consultarHomeGrupoB_notificoes', function () {
    ...
    it('tc7638_consultarHomeGrupoB_ultimaFatura', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
    ...
    it('tc7639_consultarHomeGrupoB_baixarSegundaVia', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7640_consultarHomeGrupoB_cancelarSegundaVia', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7641_consultarHomeGrupoB_pagarCom', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7642_consultarHomeGrupoB_pagarComCodigoBarras', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7643_consultarHomeGrupoB_pagarComCartaoCredito', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7644_consultarHomeGrupoB_pagarComInternetBanking', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7645_consultarHomeGrupoB_maisServicos', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7647_consultarHomeGrupoB_maisServicosVisualizarFatura', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7648_consultarHomeGrupoB_maisServicosEnviarEmail', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7649_consultarHomeGrupoB_maisServicosConhecaSuaConta', function () {
        //Última fatura
        expect(element(by.cssContainingText('.d-inline.text-ultima-fatura.group-a-text-darkgreen', 'Última fatura')));
        ExpectedConditions.presenceOf(element(by.css('.vencimento')));
        ExpectedConditions.presenceOf(element(by.css('.forma-de-pagamento')));
    ...
    it('tc7650_consultarHomeGrupoB_propaganda', function () {
        //Banner
        ExpectedConditions.presenceOf(element(by.css('.marketing')));
        //Botão de saiba mais do banner
        expect(element(by.cssContainingText('.content-button', 'Saiba mais')));
    ...
    it('tc7651_consultarHomeGrupoB_chatbot', function () {
        //Chatbot
        ExpectedConditions.presenceOf(element(by.css('.chatbot.mat-menu-trigger')));
    ...
    it('tc7652_consultarHomeGrupoB_meusServicos', function () {
        //Menu Serviços
        expect(element(by.cssContainingText('.mat-button-wrapper', 'Serviços')));
    ...
    it('tc7653_consultarHomeGrupoB_ajuda', function () {
        //Menu Ajuda
        expect(element(by.cssContainingText('.mat-button-wrapper', 'Ajuda')));
    ...
    it('tc7654_consultarHomeGrupoB_meuPerfil', function () {
        //Menu Minha conta
        expect(element(by.cssContainingText('.mat-button-wrapper', 'Minha conta')));
