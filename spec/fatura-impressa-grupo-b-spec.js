...
xdescribe('Fatura Impressa Grupo B', function() {
    ...
    it('tc9792_faturaImpressaGrB_fluxoBasico', function () {
    ...
    it('tc9793_faturaImpressaGrB_cadastroFaturaDigital', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9794_faturaImpressaGrB_noImovel', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9795_faturaImpressaGrB_enderecoAlternativo', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9796_faturaImpressaGrB_caixaPostal', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9798_faturaImpressaGrB_semCEP', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9799_faturaImpressaGrB_voltarFluxo', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9801_faturaImpressaGrB_faturaEmBraile', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9802_faturaImpressaGrB_baixarPDF', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9803_faturaImpressaGrB_imprimirFatura', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9804_faturaImpressaGrB_enderecoAlternativoCepIncompleto', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9805_faturaImpressaGrB_enderecoAlternativoCepInvalido', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9806_faturaImpressaGrB_enderecoAlternativoCepVazio', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9807_faturaImpressaGrB_enderecoAlternativo_SemConfirmacaoTarifa', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9808_faturaImpressaGrB_caixaPostal_CepIncompleto', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9809_faturaImpressaGrB_caixaPostal_CepInvalido', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9810_faturaImpressaGrB_caixaPostal_CepVazio', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
    ...
    it('tc9811_faturaImpressaGrB_caixaPostal_semConfirmacaoTarifa', function () {
        expect(element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).isDisplayed());
        element(by.cssContainingText('.t-color-light-blue-100', 'Fatura impressa')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Agora você pode receber sua fatura digital'))), 5000);
        expect(element(by.buttonText('SEGUIR COM FATURA IMPRESSA')).isDisplayed());
