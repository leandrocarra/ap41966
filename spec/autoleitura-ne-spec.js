...
xdescribe('Autoleitura NE', function() {
    ...
    it('tc11023_autoleituraNE_realizarAutoleitura', function () {
    ...
    it('tc11024_autoleituraNE_voltarAutoleitura', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11024_autoleituraNE_cancelarAutoleitura', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11028_autoleituraNE_naoCancelarAutoleitura', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11029_autoleituraNE_naoAceitarTermosAutoleitura', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11030_autoleituraNE_cliqueAquiAutoleitura', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11039_autoleituraNE_corrigirAutoleitura', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11034_autoleituraNE_semAnexarArquivo', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11041_autoleituraNE_leituraMedidorVazio', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
    ...
    it('tc11036_autoleituraNE_energiaCortada', function () {
        element(by.cssContainingText('.mat-button-wrapper', 'Serviços')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura'))), 5000);
        element(by.cssContainingText('.mat-focus-indicator.mat-menu-item.ng-star-inserted', 'Autoleitura')).click();
        browser.wait(ExpectedConditions.presenceOf(element(by.cssContainingText('.ng-star-inserted', 'Confira os dados da unidade consumidora e código do medidor para realizar a autoleitura:'))), 5000);
        ...
        expect(element(by.buttonText('CONFIRMAR AUTOLEITURA')).isEnabled(true));
        element(by.buttonText('CONFIRMAR AUTOLEITURA')).click();
        //Tela de Aviso de Energia conrtada
