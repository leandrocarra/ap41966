...
export class ContentAccordionComponent {
    ...
    @Input() historico!: LeituraDeConsumoDTO;
	...
	constructor(
        ...
        this.tipoDocumento = '';
        this.envGrupo = environment.regiao;
	}
    ...
    calcularDiasDeConsumo(dataInicio:Date, dataFim:Date): string {
    ...
    transformarData(dataRecebida: Date | string): string {
